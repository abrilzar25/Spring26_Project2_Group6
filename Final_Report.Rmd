...
```{r-Task 2:Perform an initial exploration}
library(tidyverse)
...
```{r-Day 2: Task 1 - Variable Selection & Missing Value Check}
...
```{r-Day 3: Task 1: Univariate Analysis & Visualization}
...
```{r-Day 3: Task 2: Bivariate Analysis (Boxplots Age v Sex & Age v Education)}
...
```{r-"Day 4: Task 1: Multivariate Visualization}
